...
(defn create-world [threadpool]
  (let [epsil 0.001
        ...
        rotate-teapot (comp (partial ut/flip v/axis-rotate (v/vec3 0 1 0) (/ m/PI -6.0))
                            (partial ut/flip v/axis-rotate (v/vec3 0 1 0) m/QUARTER_PI)
    ...
    [(->Sphere (v/vec3 0.0 -100.5 -1.0) 100.0 nil)
     (->Sphere (v/vec3 -0.85 0.0 -1.0) 0.25 nil)
     (->Sphere (v/vec3 0.45 -0.3 -0.5) 0.25 nil)
